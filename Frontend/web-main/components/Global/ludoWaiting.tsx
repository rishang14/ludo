      ...
      <DialogContent className="max-w-md border-2 shadow-2xl">
        <DialogHeader className="space-y-4">
          <div className="flex justify-center">
            <div className="relative">
              {/* Animated dice */}
              <div className="h-20 w-20 rounded-xl bg-primary shadow-lg animate-bounce">
                <svg viewBox="0 0 100 100" className="h-full w-full p-3 text-primary-foreground" fill="currentColor">
          ...
          <DialogTitle className="text-center text-3xl font-bold tracking-tight text-balance">
            Gathering Players
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6">
            ...
            {playerColors.slice(0, totalPlayers).map((color, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  <p className="font-semibold text-sm">{index < joinedPlayers ? "Ready" : "Waiting"}</p>
          ...
          <div className="space-y-3 text-center">
            <p className="text-lg font-semibold text-foreground">Please Wait for Others to Join</p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              The game will start automatically once all players have joined the match
            </p>
          </div>
